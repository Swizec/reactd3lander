...
Get the bonus _React, D3, and hooks_ live workshop just this week
...
<JumpToCourse
  to="#get-the-bonus-emreact-d3-and-hooksem-workshop-limited-time-only-"
...
## 🤘get the bonus <em>React, D3, and hooks</em> workshop limited time only 🤘

Every purchase of the Full Course includes a special live **_React, D3, and hooks_** workshop on **Jun 25th at 11am Pacific**. Online, via Zoom, with heaps of audience interaction.

Learn how React, D3, and hooks work together through a series of interactive exercises. Get any questions answered.

Recording yours forever, but it's more fun live 😛
...
## 🤘get bonus <em>React, D3, and hooks</em> live workshop limited time only 🤘
