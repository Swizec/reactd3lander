...
import { Banner, NavGrid, Container, Grid, Title, JumpToCourse, LazyImage, Testimonial } from ".."
...
{/_ Offering **37% off while The Situation lasts** because that's how far the markets dropped and I figured you might be worried so I wanna help. ❤️ _/}
