...
Our goal is to create a faux live map of airplane positions. We can fetch real
...
![](https://github.com/Swizec/datavizAdvent/blob/master/src/content/webgl-airplanes/airplane-icon.jpg?raw=true)
