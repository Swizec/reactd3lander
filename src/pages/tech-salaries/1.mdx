...
_This section is currently being re-recorded with hooks from the ground up. Updated up to the "meta info" portion. Should be finished by Jun 22, all code compatible so feel free to go ahead :)_
