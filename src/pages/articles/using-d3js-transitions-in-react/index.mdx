...
description: "One of d3’s biggest selling points is the general update pattern. Add some function calls and voila – animated visualization with transitions. You totally _can_ achieve the same result with React. Yes, even if you use React to render SVG. Yes, you can use d3’s powerful transitions API too. The React version is easier to understand, too. Keep reading and you’ll see why."
date: "2016-04-28T08:00:00.000Z"
lastUpdated: "2016-04-28T08:00:00.000Z"
---

# ![alphabet_2](./img/blog-wp-content-uploads-2016-04-alphabet_2.gif)
