...
description: "The Flash of Doom is one of the most annoying issues with D3 charts. You load the page, then you load the data, then you render your chart. With React 16, we can fix that using server-side rendering."
