...
description: "The Flash of Doom is one of the most annoying issues with D3 charts. You load the page, then you load the data, _then_ you render your chart. With React 16, we can fix that using server-side rendering."
date: "2017-09-28T08:00:00.000Z"
lastUpdated: "2017-09-28T08:00:00.000Z"
image: "./img/wikipedia-commons-3-3b-Paris_Tuileries_Garden_Facepalm_statue.jpg"
---
...
![](./img/blog-wp-content-uploads-2017-09-server-side-d3.gif)
...
![](./img/blog-wp-content-uploads-2017-09-server-side-d3-no-flash.gif)
...
![](./img/wikipedia-commons-3-3b-Paris_Tuileries_Garden_Facepalm_statue.jpg)
