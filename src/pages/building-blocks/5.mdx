...
Now that you know more about the basics of hooks, and you've got the mental models of combining D3 and React for modern dataviz, let's build those building blocks with hooks.
