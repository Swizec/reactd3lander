...
description:
  "Have you ever tried making a sankey diagram with d3+react, I can''t seem to make it work for some reason.:/" ~Emil
date: 2018-12-16T08:00:00.000Z
lastUpdated: 2018-12-16T08:00:00.000Z
image: './sankey.png'
---

<Video id="SAmKimb8wFo" />
...
<a href={`./ugr-sankey-openspending.json`}>
                  Download dataset 🗳{' '}
                </a>

##My solution 👇

Codepen: `https://codesandbox.io/s/m9vy7mr5k8`
