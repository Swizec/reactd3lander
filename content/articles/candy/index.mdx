...
<Video id="Dn_kHCFTUP4" />

Candy is delicious. When do people buy it most? Visualize the data in a fun way

<strong>Dataset: </strong>
<a href={`./statistic_id947149_retail-sales-of-candy-in-the-united-states-in-2018-by-week.xlsx`}>
                  Download dataset 🗳{' '}
                </a>

##My solution 👇

Codepen: `https://codesandbox.io/s/ov0lzxmplz`
