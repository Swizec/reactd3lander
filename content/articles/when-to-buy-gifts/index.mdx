...
<Video id="VzAAGCudLe8" />

My girlfriend likes to buy her presents early, I wait until the last minute. What do other people do? Create a way to visualize the last few weeks of the year and rank them by popularity.

<strong>Dataset: </strong>
<a href={`./statistic_id246669_period-during-which-us-consumers-will-start-holiday-shopping-2018.xlsx`}>
                  Download dataset 🗳{' '}
                </a>

##My solution 👇

Codepen: `https://codesandbox.io/s/oq730593n9`
